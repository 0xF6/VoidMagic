package ivysola.voidmagic.recipe;
...
public class NodalRecipes
{
    ...
    public NodalRecipes()
    {
        matrixRecipe = new ShapedArcaneRecipe("NODECATALYZATION", new ItemStack(VoidItems.itemMatrix), new AspectList().add(Aspect.ORDER, 20).add(Aspect.ENTROPY, 20), new Object[] {
                "XYX",
                "YZY",
                "XYX",
        ...
        ItemStack variedAttune = new ItemStack(VoidItems.itemMatrix);
        ...
        variedAttuneRecipe = new ShapedArcaneRecipe("NODECATALYZATION", variedAttune, new AspectList().add(Aspect.ORDER, 8), new Object[] {
                ...
                Character.valueOf('X'), VoidItems.itemMatrix
        });
        ...
        ItemStack sameAttune = new ItemStack(VoidItems.itemMatrix);
        ...
        sameAttuneRecipe = new ShapedArcaneRecipe("NODECATALYZATION", sameAttune, new AspectList().add(Aspect.ORDER, 8), new Object[] {
                ...
                Character.valueOf('B'), VoidItems.itemMatrix
        });
    ...
    {
        ThaumcraftApi.addArcaneCraftingRecipe("NODECATALYZATION", new ItemStack(VoidItems.itemMatrix), new AspectList().add(Aspect.ORDER, 20).add(Aspect.ENTROPY, 20), new Object[]{
                "XYX",
                "YZY",
                "XYX",
                Character.valueOf('X'), ItemApi.getItem("itemResource", 14),
