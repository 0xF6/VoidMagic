...
public class RecipeNode extends InfusionRecipe
{
    ...
    public RecipeNode()
    {
        super("NODECATALYZATION", ItemApi.getItem("itemJarNode", 0), INSTABILITY, new AspectList(), new ItemStack(VoidItems.itemMatrix), new ItemStack[]{ItemApi.getItem("itemResource", 14), ItemApi.getItem("itemResource", 14)});
        rand = new Random();
    }
    ...
    public boolean matches(ArrayList<ItemStack> input, ItemStack central, World world, EntityPlayer player)
    {
        ...
        if (central != null && central.getItem().equals(VoidItems.itemMatrix))
        {
