...
public class ItemMatrix extends Item
{
    ...
    public ItemMatrix()
    {
        ...
        this.setUnlocalizedName("voidmagic.matrix");
    }
    ...
    {
        this.icon = reg.registerIcon(VoidMagic.modID.toLowerCase(Locale.ENGLISH) + ":" + "itemMatrix");
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List infoList, boolean advancedTooltips)
    {
        if (stack.hasTagCompound() && stack.getTagCompound().hasKey("aspects"))
        {
            ...
            infoList.add(FormatCodes.DarkGrey.code + FormatCodes.Italic.code + StatCollector.translateToLocal("tooltip.voidmagic.matrix.attuned"));
        }
        else
            infoList.add(FormatCodes.DarkGrey.code + FormatCodes.Italic.code + StatCollector.translateToLocal("tooltip.voidmagic.matrix.unattuned"));
    }
}
